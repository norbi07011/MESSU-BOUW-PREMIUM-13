...
import { FileText, Users, Package, ChartBar, Gear, Download, DeviceMobile, Car, Receipt, Clock } from '@phosphor-icons/react';
...
type Page = 'reports' | 'invoices' | 'invoices-new' | 'clients' | 'products' | 'expenses' | 'kilometers' | 'timesheets' | 'btw' | 'settings';
...
🆘 POMOC: support@messubouw.com`;
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-sky-50 via-blue-50 to-sky-100 dark:bg-black transition-colors duration-300">
      {/* Modern Header with Download Buttons & Theme Switcher */}
      <header className="premium-card relative bg-white/90 dark:bg-black/95 backdrop-blur-md !border-black dark:!border-0 !shadow-[0_4px_20px_rgba(59,130,246,0.3)] dark:!shadow-[0_8px_30px_rgba(59,130,246,0.7),0_4px_15px_rgba(59,130,246,0.5)]">
        <div className="relative flex items-center justify-between px-6 py-4">
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 rounded-xl overflow-hidden border-2 border-black dark:border-blue-500 shadow-[0_0_15px_rgba(59,130,246,0.4)] dark:shadow-[0_0_20px_rgba(59,130,246,0.6)]">
              <img
            ...
            <div>
              <h1 className="text-2xl font-bold bg-gradient-to-r from-sky-600 to-blue-600 dark:from-blue-400 dark:to-blue-500 bg-clip-text text-transparent">
                MESSU BOUW
              </h1>
              <span className="text-sm text-slate-600 dark:text-slate-400">Invoice Management System</span>
            </div>
          </div>
      ...
      <div className="flex">
        <aside className="premium-card w-72 min-h-screen bg-white/95 dark:bg-black/95 backdrop-blur-md !rounded-none !border-black dark:!border-0">
          <div className="p-6 border-b-2 border-black dark:border-blue-500">
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 rounded-lg overflow-hidden border-2 border-black dark:border-blue-500 shadow-[0_0_15px_rgba(59,130,246,0.4)] dark:shadow-[0_0_20px_rgba(59,130,246,0.6)]">
                <img 
                  src="/messu-bouw-logo.jpg" 
                  alt="MESSU BOUW" 
                  className="w-full h-full object-cover"
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">Invoice Management</p>
              </div>
            </div>
          </div>
          <nav className="px-4 py-6 space-y-2">
            {navItems.map((item) => {
              ...
              return (
                <button
                  key={item.id}
                  className={`premium-button w-full flex items-center gap-3 px-4 py-3 transition-all duration-200 text-left font-medium ${
                    isActive 
                      ? 'bg-gradient-to-r from-sky-500 to-blue-600 dark:from-blue-500 dark:to-blue-600 text-white !border-black dark:!border-0 !shadow-[0_4px_20px_rgba(59,130,246,0.5)] dark:!shadow-[0_8px_30px_rgba(59,130,246,0.8),0_4px_15px_rgba(59,130,246,0.6)]' 
