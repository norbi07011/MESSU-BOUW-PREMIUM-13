...
const ChartSkeleton = () => (
  <Card className="dark:bg-black dark:border dark:border-gray-400/30 dark:backdrop-blur-md dark:shadow-[0_0_20px_rgba(59,130,246,0.3)]">
    <CardHeader>
      <div className="h-6 bg-slate-200 dark:bg-gray-700/50 rounded w-1/3 animate-pulse"></div>
    </CardHeader>
    <CardContent>
      <div className="h-64 bg-slate-100 dark:bg-gray-800/30 rounded animate-pulse flex items-center justify-center">
        <div className="text-slate-400 dark:text-white">Ładowanie wykresu...</div>
      </div>
    </CardContent>
  </Card>
);
...
export default function Reports() {
  ...
  if (availableYears.length === 0) {
    return (
      <div className="container mx-auto p-6 max-w-7xl min-h-screen dark:bg-black">
        <h1 className="text-3xl font-semibold mb-6 dark:text-white">{t('reports.title')}</h1>
        <Card className="dark:bg-black dark:border dark:border-gray-400/30 dark:backdrop-blur-md dark:shadow-[0_0_20px_rgba(59,130,246,0.3)]">
          <CardContent className="py-12">
            <p className="text-center text-black dark:text-white">{t('reports.noData')}</p>
          </CardContent>
        </Card>
      </div>
    );
  ...
  return (
    <div className="container mx-auto p-6 max-w-7xl space-y-6 min-h-screen dark:bg-black">
      {/* UKŁAD: Film po lewej + Tekst z przyciskiem po prawej */}
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
        {/* LEWA STRONA: Film */}
          <div className="relative overflow-hidden rounded-3xl bg-black border-4 border-black dark:border-blue-500 shadow-[0_0_40px_rgba(59,130,246,0.7)] dark:shadow-[0_20px_50px_rgba(59,130,246,0.8),0_8px_25px_rgba(59,130,246,0.6)] h-64 md:h-72 lg:h-80">
          <video 
            autoPlay 
            loop 
            muted={isMuted}
        ...
        <div className="flex flex-col justify-center px-4 md:px-6 lg:px-8">
          <h1 className="text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-black text-black dark:text-white mb-3 md:mb-4 tracking-tight">
            📊 Raporty
          </h1>
          <p className="text-xl lg:text-2xl text-black dark:text-white mb-8 font-medium">
            Kompleksowa analiza finansowa dla ZZP
          </p>
          <div className="flex flex-wrap items-center gap-4">
            <Select value={selectedYear} onValueChange={setSelectedYear}>
              <SelectTrigger className="w-40 bg-gradient-to-r from-sky-500 to-blue-600 hover:from-sky-600 hover:to-blue-700 dark:from-blue-500 dark:to-blue-600 dark:hover:from-blue-600 dark:hover:to-blue-700 text-white border-0 font-bold">
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
            ...
            <button onClick={handleExportCSV} className="premium-button px-8 py-3 bg-gradient-to-r from-sky-500 to-blue-600 hover:from-sky-600 hover:to-blue-700 dark:from-blue-500 dark:to-blue-600 dark:hover:from-blue-600 dark:hover:to-blue-700 dark:shadow-[0_0_20px_rgba(59,130,246,0.5)] text-white font-bold text-base flex items-center gap-2">
      ...
      {report.statusWarnings.length > 0 && (
        <div className="space-y-2">
          {report.statusWarnings.map((warning, idx) => (
            <Card key={idx} className={`premium-card dark:bg-black dark:border dark:border-blue-500/50 dark:backdrop-blur-md dark:shadow-[0_0_20px_rgba(59,130,246,0.3)] ${warning.type === 'warning' ? 'border-blue-500' : 'border-blue-500'}`}>
              <CardContent className="flex items-start gap-3 p-4">
                {warning.type === 'warning' ? (
                  <Warning className="text-yellow-600 dark:text-blue-400 shrink-0 mt-0.5" size={20} />
                ) : (
                  <Info className="text-blue-600 dark:text-blue-400 shrink-0 mt-0.5" size={20} />
                )}
                <p className="text-sm dark:text-white">{warning.message}</p>
              </CardContent>
            </Card>
          ))}
        </div>
      ...
      <Tabs defaultValue="charts" className="space-y-6">
        ...
        <TabsContent value="charts" className="space-y-6">
          ...
          <Card className="border-2 border-slate-200 dark:border-blue-500/50 dark:bg-black dark:backdrop-blur-md dark:shadow-[0_0_20px_rgba(59,130,246,0.3)]">
            <CardContent className="p-6">
              <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                ...
                <div className="flex flex-wrap items-center gap-4">
                  ...
                  <Badge variant="outline" className="text-sm dark:bg-gray-700/50 dark:text-white dark:border-blue-500/30">
                    {report.invoiceCount} faktur | €{report.totalNet.toLocaleString('nl-NL')} netto
                  </Badge>
                  
                  {hasRefunds && (
                    <Badge className="bg-emerald-500 text-white dark:bg-blue-500 dark:text-white">
                ...
                <div className="flex items-center gap-2">
                  <Button
                    ...
                    className="gap-2 dark:bg-blue-500 dark:text-white dark:border-blue-500/50 dark:hover:bg-blue-600"
                  >
                  ...
                  <Button
                    ...
                    className="gap-2 bg-gradient-to-r from-purple-500 to-blue-500 dark:from-blue-500 dark:to-blue-600 dark:hover:from-blue-600 dark:hover:to-blue-700"
                  >
                    <DownloadSimple size={16} weight="bold" />
                    Export PDF
                  </Button>
          ...
          <Card className="mt-4 bg-white/95 dark:bg-black dark:backdrop-blur-md dark:border-blue-500/50 dark:shadow-[0_0_20px_rgba(59,130,246,0.3)] border-blue-200">
          ...
          {(hasRefunds || hasPayments) && (
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
              <Card className={`border-2 ${annualVATSummary.netBalance < 0 ? 'border-blue-500 bg-white/95 dark:bg-white/5 backdrop-blur-md' : 'border-blue-500 bg-white/95 dark:bg-white/5 backdrop-blur-md'}`}>
                ...
                <CardContent>
                  <div className={`text-3xl font-black ${annualVATSummary.netBalance < 0 ? 'text-emerald-600 dark:text-blue-400' : 'text-orange-600 dark:text-blue-400'}`}>
              ...
              <Card className="dark:bg-black dark:border dark:border-blue-500/50 dark:backdrop-blur-md dark:shadow-[0_0_20px_rgba(59,130,246,0.3)]">
                <CardHeader className="pb-2">
                  <CardTitle className="text-sm font-medium">VAT należny</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="text-2xl font-bold text-rose-600 dark:text-blue-400">
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-2xl font-bold text-emerald-600 dark:text-blue-400">
              ...
              <Card>
                ...
                <CardContent>
                  <div className="flex gap-2">
                    <div className="flex-1 text-center p-2 bg-emerald-100 dark:bg-emerald-900/30 rounded">
                      <div className="text-xl font-bold text-emerald-600 dark:text-blue-400">
                        {annualVATSummary.refundMonths}
                      </div>
                      <div className="text-xs text-blue-700 dark:text-emerald-300">
                        Zwroty
                      </div>
                    </div>
                    <div className="flex-1 text-center p-2 bg-orange-100 dark:bg-orange-900/30 rounded">
                      <div className="text-xl font-bold text-orange-600 dark:text-blue-400">
                        {annualVATSummary.paymentMonths}
                      </div>
                      <div className="text-xs text-blue-700 dark:text-orange-300">
                        Wpłaty
                      </div>
                    </div>
                  </div>
          ...
          <Card className="mt-4 bg-white/95 dark:bg-white/5 backdrop-blur-md border-blue-200 dark:border-blue-500/30">
            <CardContent className="pt-6">
              <div className="flex gap-3 mb-4">
                <div className="flex-shrink-0 w-10 h-10 rounded-full bg-gradient-to-br from-blue-500 to-sky-600 shadow-lg flex items-center justify-center text-white font-bold">
                  📊
                </div>
                <div>
                  <h4 className="font-bold text-blue-900 dark:text-blue-100 mb-2">
              ...
              <div className="bg-white/95 dark:bg-white/5 backdrop-blur-md rounded-lg p-4 border-l-4 border-blue-500 mb-4">
                ...
                <div className="space-y-3 text-sm text-black dark:text-white">
                  <div className="bg-white/95 dark:bg-white/5 backdrop-blur-md p-3 rounded-lg border-l-4 border-blue-500">
                    <strong className="text-blue-700 dark:text-blue-400">✅ Kiedy możesz skorzystać:</strong>
                  ...
                  <div className="bg-white/95 dark:bg-white/5 backdrop-blur-md p-3 rounded">
                    <strong className="text-blue-700 dark:text-blue-400">💰 Korzyści KOR:</strong>
                    <ul className="mt-2 ml-4 space-y-1">
                  ...
                  <div className="bg-white/95 dark:bg-white/5 backdrop-blur-md p-3 rounded-lg border-l-4 border-blue-500">
                    <strong className="text-blue-700 dark:text-blue-400">⚠️ Wady KOR:</strong>
                    <ul className="mt-2 ml-4 space-y-1">
                  ...
                  <div className="bg-white/95 dark:bg-white/5 backdrop-blur-md p-3 rounded-lg border-l-4 border-blue-500">
                    <strong className="text-blue-700 dark:text-blue-400">💡 Strategia optymalizacji VAT:</strong>
                    <p className="mt-2">
          ...
          <Card className="mt-4 bg-white/95 dark:bg-white/5 backdrop-blur-md border-blue-200 dark:border-blue-500/30">
            <CardContent className="pt-6">
              ...
              <div className="bg-white/95 dark:bg-white/5 backdrop-blur-md rounded-lg p-4 border-l-4 border-blue-500 mb-4">
                ...
                <div className="space-y-3 text-sm text-black dark:text-white">
                  <div className="bg-white/95 dark:bg-white/5 backdrop-blur-md p-3 rounded-lg border-l-4 border-blue-500">
                    <strong className="text-blue-700 dark:text-blue-400">📋 Stawki kilometrówki 2025:</strong>
                    <ul className="mt-2 ml-4 space-y-1">
                  ...
                  <div className="bg-white/95 dark:bg-white/5 backdrop-blur-md p-3 rounded-lg border-l-4 border-blue-500">
                    <strong className="text-blue-700 dark:text-blue-400">✅ Co liczy się jako kilometr służbowy:</strong>
                    <ul className="mt-2 ml-4 space-y-1">
                  ...
                  <div className="bg-white/95 dark:bg-white/5 backdrop-blur-md p-3 rounded-lg border-l-4 border-blue-500">
                    <strong className="text-blue-700 dark:text-blue-400">❌ Co NIE jest kilometrem służbowym:</strong>
                    <ul className="mt-2 ml-4 space-y-1">
                  ...
                  <div className="bg-white/95 dark:bg-white/5 backdrop-blur-md p-3 rounded-lg border-l-4 border-blue-500">
                    <strong className="text-blue-700 dark:text-blue-400">🎯 Strategia maksymalizacji odliczeń:</strong>
                    <div className="mt-2 space-y-2">
                      ...
                      <p className="mt-2 bg-gradient-to-r from-blue-50 to-sky-50 dark:from-blue-500/10 dark:to-blue-400/10 backdrop-blur-md p-2 rounded-lg border border-blue-200 dark:border-blue-500/30">
                        <strong className="text-blue-700 dark:text-blue-400">💡 Pro tip:</strong> Przy 15,000 km służbowych rocznie odliczasz €3,150 + VAT z paliwa (~€500) = <strong>€3,650 oszczędności!</strong>
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <Card className="mt-4 bg-white/95 dark:bg-white/5 backdrop-blur-md border-blue-200 dark:border-blue-500/30">
            <CardContent className="pt-6">
              <div className="flex gap-3 mb-4">
                <div className="flex-shrink-0 w-10 h-10 rounded-full bg-gradient-to-br from-blue-500 to-sky-600 flex items-center justify-center text-white font-bold">
                  🎯
                </div>
                <div>
                  <h4 className="font-bold text-blue-900 dark:text-blue-100 mb-2">
              ...
              <div className="bg-white/95 dark:bg-white/5 backdrop-blur-md rounded-lg p-4 border-l-4 border-blue-500 mb-4">
                ...
                <div className="space-y-3 text-sm text-black dark:text-white">
                  <div className="bg-white/95 dark:bg-white/5 backdrop-blur-md p-4 rounded-lg border-l-4 border-blue-500">
                    <strong className="text-blue-700 dark:text-blue-400 text-lg">2025: €3,750 odliczenia!</strong>
                    <p className="mt-2">
                      Jeśli spełniasz warunki, możesz odliczyć €3,750 od podstawy opodatkowania. 
                      Przy stawce 37% = <strong className="text-blue-600 dark:text-blue-400">€1,387.50 oszczędności rocznie!</strong>
                    </p>
                  </div>
                  
                  <div className="bg-white/95 dark:bg-white/5 backdrop-blur-md p-3 rounded-lg border-l-4 border-blue-500">
                    <strong className="text-blue-700 dark:text-blue-400">✅ Warunki (MUSISZ spełnić wszystkie!):</strong>
                  ...
                  <div className="bg-white/95 dark:bg-white/5 backdrop-blur-md p-3 rounded-lg border-l-4 border-blue-500">
                    <strong className="text-blue-700 dark:text-blue-400">⏰ Wykres progresywny odliczenia:</strong>
                    <ul className="mt-2 ml-4 space-y-1">
                    ...
                    <p className="mt-2 bg-gradient-to-r from-blue-50 to-sky-50 dark:from-blue-500/10 dark:to-blue-400/10 backdrop-blur-md p-2 rounded-lg border border-blue-200 dark:border-blue-500/30 font-bold text-blue-700 dark:text-blue-400">
                      ⚠️ Rząd holenderski stopniowo likwiduje tę ulgę! Wykorzystaj teraz póki można!
                    </p>
                  </div>

                  <div className="bg-white/95 dark:bg-white/5 backdrop-blur-md p-3 rounded-lg border-l-4 border-blue-500">
                    <strong className="text-blue-700 dark:text-blue-400">📊 MKB-winstvrijstelling (14% zwolnienia z zysku):</strong>
                    <p className="mt-2">
                      Dodatkowe 14% Twojego zysku jest zwolnione z podatku! Automatyczne dla wszystkich ZZP.
                    </p>
                    <p className="mt-2 bg-white/95 dark:bg-white/5 backdrop-blur-md p-2 rounded-lg border-l-4 border-blue-500">
                      <strong>Przykład:</strong> Zysk €50,000 → 14% (€7,000) wolne od podatku → opodatkowane tylko €43,000!
                    </p>
                  </div>

                  <div className="bg-white/95 dark:bg-white/5 backdrop-blur-md p-4 rounded-lg border-2 border-blue-500">
                    <strong className="text-blue-700 dark:text-blue-400 text-lg">💰 Przykład oszczędności rocznych:</strong>
                    <div className="mt-3 space-y-2 font-mono text-sm">
                      ...
                      <div className="mt-3 bg-white/95 dark:bg-white/5 backdrop-blur-md p-2 rounded-lg border-l-4 border-blue-500">
              ...
              <div className="bg-white/95 dark:bg-white/5 backdrop-blur-md rounded-lg p-4 border-l-4 border-blue-500 mb-4">
                <h5 className="font-bold text-blue-700 dark:text-blue-400 mb-3">
                ...
                <div className="space-y-2 text-sm text-black dark:text-white">
                  ...
                  <div className="bg-white/95 dark:bg-white/5 backdrop-blur-md p-3 rounded-lg border-l-4 border-blue-500 mt-3">
                    <strong className="text-blue-700 dark:text-blue-400">💡 Strategia przy przekroczeniu €75,518:</strong>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-black dark:text-white mt-1">Including VAT</p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-black dark:text-white mt-1">Excluding VAT</p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-black dark:text-white mt-1">To be returned to Belastingdienst</p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-black dark:text-white mt-1">Total invoices in {selectedYear}</p>
              </CardContent>
            </Card>
          </div>
        ...
        <TabsContent value="tax" className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold font-mono">{formatCurrency(report.totalNet, i18n.language)}</div>
                <p className="text-xs text-black dark:text-white mt-1">Total revenue before deductions</p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-black dark:text-white mt-1">Self-employed tax deduction</p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-black dark:text-white mt-1">14% profit exemption for SMEs</p>
              </CardContent>
            </Card>
          </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="mt-6 p-4 bg-white/95 dark:bg-white/5 backdrop-blur-md border border-blue-200 dark:border-blue-500/30 rounded-lg">
                <h4 className="font-semibold text-sm mb-2 flex items-center gap-2 text-black dark:text-white">
        ...
        <TabsContent value="vat" className="space-y-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="mt-4 p-4 bg-white/95 dark:bg-white/5 backdrop-blur-md border border-blue-200 dark:border-blue-500/30 rounded-lg">
                <h4 className="font-semibold text-sm mb-2 flex items-center gap-2 text-black dark:text-white">
                  <Warning size={16} className="text-yellow-600 dark:text-yellow-400" />
          ...
          <Card>
            ...
            <CardContent>
              {report.topClients.length === 0 ? (
                <p className="text-center text-black dark:text-white py-8">{t('reports.noData')}</p>
              ) : (
                <Table>
                  <TableHeader>
                    <TableRow>
                  ...
                  <TableBody>
                    {report.topClients.map((client, index) => (
                      <TableRow key={index}>
                        <TableCell className="font-bold text-black dark:text-white">#{index + 1}</TableCell>
