    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900">
      <div className="max-w-7xl mx-auto p-6 space-y-8">
          ...
          <div className="flex flex-col justify-center px-4 md:px-6 lg:px-8">
            ...
            <Dialog open={showDialog} onOpenChange={(open) => { setShowDialog(open); if (!open) resetForm(); }}>
              <DialogTrigger asChild>
                <button className="px-10 py-5 bg-blue-600 hover:bg-blue-700 text-white rounded-2xl font-black text-lg shadow-2xl transition-all duration-500 hover:scale-105 flex items-center gap-3 w-fit">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <Card className="bg-white/95 dark:bg-white/5 backdrop-blur-md border border-blue-200 dark:border-blue-500/30 shadow-xl">
            <CardHeader className="pb-2">
              <CardTitle className="text-sm text-black dark:text-white">Suma Netto</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="text-2xl font-bold text-blue-700 dark:text-blue-400">
                {formatCurrency(totals.net, i18n.language)}
              </div>
              <div className="text-xs text-black dark:text-white mt-1">{totals.count} wydatków</div>
            </CardContent>
          </Card>

          <Card className="bg-white/95 dark:bg-white/5 backdrop-blur-md border border-blue-200 dark:border-blue-500/30 shadow-xl">
            <CardHeader className="pb-2">
              <CardTitle className="text-sm text-black dark:text-white">VAT</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="text-2xl font-bold text-blue-700 dark:text-blue-400">
                {formatCurrency(totals.vat, i18n.language)}
              </div>
              <div className="text-xs text-black dark:text-white mt-1">Suma VAT</div>
            </CardContent>
          </Card>

          <Card className="bg-white/95 dark:bg-white/5 backdrop-blur-md border border-blue-200 dark:border-blue-500/30 shadow-xl">
            <CardHeader className="pb-2">
              <CardTitle className="text-sm text-black dark:text-white">Do odliczenia</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="text-2xl font-bold text-blue-700 dark:text-blue-400">
                {formatCurrency(totals.deductibleVat, i18n.language)}
              </div>
              <div className="text-xs text-black dark:text-white mt-1">VAT do odliczenia</div>
            </CardContent>
          </Card>

          <Card className="bg-white/95 dark:bg-white/5 backdrop-blur-md border border-blue-200 dark:border-blue-500/30 shadow-xl">
            <CardHeader className="pb-2">
              <CardTitle className="text-sm text-black dark:text-white">Suma Brutto</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="text-2xl font-bold text-blue-700 dark:text-blue-400">
                {formatCurrency(totals.gross, i18n.language)}
              </div>
              <div className="text-xs text-black dark:text-white mt-1">Całkowity koszt</div>
            </CardContent>
          </Card>
        </div>

        {/* Expenses Table */}
        <Card className="bg-white/80 backdrop-blur-sm border border-blue-200 dark:border-blue-500/30 shadow-xl">
          <CardHeader>
