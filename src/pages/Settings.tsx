                    ...
                    <div className="flex-1">
                      ...
                      <div className="mt-4 flex space-x-3">
                        <Button
                          ...
                          className="bg-gradient-to-r from-sky-500 to-blue-600 hover:from-sky-600 hover:to-blue-700 dark:from-blue-500 dark:to-blue-600 dark:hover:from-blue-400 dark:hover:to-blue-500 dark:shadow-[0_0_20px_rgba(59,130,246,0.5)]"
                        >
                ...
                <div className="border rounded-lg p-6 bg-linear-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20">
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="mt-3 p-3 bg-white/95 dark:bg-white/10 rounded border-l-4 border-blue-500">
                        <p className="text-sm font-medium text-blue-800 dark:text-blue-300">
                          📡 Aktualny adres sieciowy:
                        </p>
                        <div className="mt-2 space-y-1">
                          <code className="block text-xs bg-blue-50 dark:bg-blue-950/30 p-2 rounded font-mono">
                            {networkUrl}
                          </code>
                ...
                <div className="border rounded-lg p-6 bg-linear-to-r from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20">
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="mt-3 space-y-2 text-sm text-black dark:text-gray-300">
