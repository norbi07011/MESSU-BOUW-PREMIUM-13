...
export function Timesheets() {
      ...
      <div className="max-w-7xl mx-auto p-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          ...
          <div className="flex flex-col justify-center px-4 md:px-6 lg:px-8">
            ...
            <p className="text-lg md:text-xl lg:text-2xl text-black dark:text-white mb-6 md:mb-8 font-medium">
              Twórz profesjonalne karty czasu pracy
            </p>
            <button onClick={createNewTimesheet} className="px-10 py-5 bg-cyan-600 hover:bg-cyan-700 text-white rounded-2xl font-black text-lg shadow-2xl transition-all duration-500 hover:scale-105 flex items-center gap-3 w-fit">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {timesheets.length === 0 ? (
            <div className="col-span-full text-center py-16">
              <Clock size={64} className="mx-auto text-black dark:text-white mb-4" />
            ...
            timesheets.map(sheet => (
              <div
                key={sheet.id}
                className="bg-white/95 dark:bg-white/5 backdrop-blur-md border border-blue-200 dark:border-blue-500/30 rounded-xl p-6 hover:shadow-lg dark:hover:shadow-[0_0_20px_rgba(59,130,246,0.2)] transition-all cursor-pointer"
              ...
              >
                <div className="flex items-start justify-between mb-4">
                  ...
                  <Clock size={24} className="text-sky-500 dark:text-blue-400" />
                </div>
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex items-center gap-2 text-sky-600 dark:text-blue-400 font-bold">
                    <CurrencyEur size={16} />
  ...
  return (
    <div className="max-w-7xl mx-auto p-6">
      {/* Header z akcjami */}
      <div className="bg-white/95 dark:bg-white/5 backdrop-blur-md border border-blue-200 dark:border-blue-500/30 rounded-xl p-6 mb-6 shadow-lg">
        <div className="flex items-center justify-between">
          ...
          <div className="flex gap-3">
            <button
              ...
              className="px-4 py-2 bg-blue-100 dark:bg-blue-950/30 text-blue-700 dark:text-blue-400 rounded-lg hover:bg-blue-200 dark:hover:bg-blue-900/40 transition-all"
            >
              Anuluj
            </button>
            <button
            ...
            <button
              ...
              className="px-4 py-2 bg-blue-500 dark:bg-blue-600 text-white rounded-lg hover:bg-blue-600 dark:hover:bg-blue-700 transition-all shadow-lg"
            >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
        {/* Dane pracownika */}
        <div className="bg-white/95 dark:bg-white/5 backdrop-blur-md border border-blue-200 dark:border-blue-500/30 rounded-xl p-6">
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2 border border-blue-200 dark:border-blue-500/30 rounded-lg bg-white/95 dark:bg-white/10 text-black dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent"
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2 border border-sky-200 dark:border-blue-500/30 rounded-lg bg-white dark:bg-black/80 text-black dark:text-white focus:ring-2 focus:ring-sky-500 dark:focus:ring-blue-500 focus:border-transparent"
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2 border border-sky-200 dark:border-blue-500/30 rounded-lg bg-white dark:bg-black/80 text-black dark:text-white focus:ring-2 focus:ring-sky-500 dark:focus:ring-blue-500 focus:border-transparent font-mono"
                placeholder="20.00"
              />
            </div>
          </div>
      ...
      {/* Tabela godzin */}
      <div className="bg-white/95 dark:bg-white/5 backdrop-blur-md border border-blue-200 dark:border-blue-500/30 rounded-xl p-6 overflow-x-auto">
        <h3 className="text-lg font-bold text-black dark:text-white mb-4 flex items-center gap-2">
        ...
        <table className="w-full">
          <thead>
            <tr className="border-b-2 border-sky-200 dark:border-blue-500/30">
              <th className="text-left py-3 px-2 text-sm font-bold text-black dark:text-white">Dzień</th>
              <th className="text-left py-3 px-2 text-sm font-bold text-black dark:text-white">Data</th>
              <th className="text-left py-3 px-2 text-sm font-bold text-black dark:text-white">Start</th>
              <th className="text-left py-3 px-2 text-sm font-bold text-black dark:text-white">Koniec</th>
              <th className="text-left py-3 px-2 text-sm font-bold text-black dark:text-white">Przerwa (min)</th>
              <th className="text-left py-3 px-2 text-sm font-bold text-black dark:text-white">Godziny</th>
              <th className="text-left py-3 px-2 text-sm font-bold text-black dark:text-white">Kwota (€)</th>
              <th className="text-left py-3 px-2 text-sm font-bold text-black dark:text-white">Uwagi</th>
            </tr>
          </thead>
          <tbody>
            {currentSheet.days.map((day, index) => (
              <tr 
                key={day.date}
                className="border-b border-blue-100 dark:border-blue-500/20 hover:bg-blue-50 dark:hover:bg-blue-950/20"
              >
                <td className="py-3 px-2 font-medium text-black dark:text-white">
                  {day.dayName}
                </td>
                <td className="py-3 px-2 text-sm text-black dark:text-white">
                ...
                <td className="py-3 px-2">
                  <input
                    ...
                    className="w-24 px-2 py-1 border border-sky-200 dark:border-blue-500/30 rounded bg-white dark:bg-black/80 text-black dark:text-white text-sm font-mono"
                ...
                <td className="py-3 px-2">
                  <input
                    ...
                    className="w-20 px-2 py-1 border border-sky-200 dark:border-blue-500/30 rounded bg-white dark:bg-black/80 text-black dark:text-white text-sm font-mono"
                    aria-label="Przerwa w minutach"
                    title="Przerwa w minutach"
                  />
                </td>
                <td className="py-3 px-2 font-bold text-sky-600 dark:text-blue-400 font-mono">
                  {day.workedHours.toFixed(2)}h
                </td>
                <td className="py-3 px-2 font-bold text-black dark:text-white font-mono">
                ...
                <td className="py-3 px-2">
                  <input
                    ...
                    className="w-full px-2 py-1 border border-blue-200 dark:border-blue-500/30 rounded bg-white/95 dark:bg-white/10 text-black dark:text-white text-sm"
                    placeholder="Uwagi..."
                  />
                </td>
              </tr>
          ...
          <tfoot>
            <tr className="border-t-2 border-blue-300 dark:border-blue-500/50 bg-blue-50 dark:bg-blue-950/20">
              <td colSpan={5} className="py-4 px-2 text-right font-bold text-black dark:text-white">
                RAZEM:
              </td>
              <td className="py-4 px-2 font-bold text-sky-600 dark:text-blue-400 text-lg font-mono">
                {currentSheet.totalHours.toFixed(2)}h
              </td>
              <td className="py-4 px-2 font-bold text-black dark:text-white text-lg font-mono">
      ...
      {showPreview && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white/95 dark:bg-white/5 backdrop-blur-md rounded-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
            <div className="p-6 border-b border-blue-200 dark:border-blue-500/30 flex items-center justify-between sticky top-0 bg-white/95 dark:bg-white/5">
              <h3 className="text-xl font-bold text-black dark:text-white">Podgląd Wydruku</h3>
              <div className="flex gap-3">
                <button
                  onClick={handlePrint}
                  className="px-4 py-2 bg-sky-500 dark:bg-blue-500 text-white rounded-lg hover:bg-sky-600 dark:hover:bg-blue-600 transition-all"
                >
                  <Printer size={18} className="inline mr-2" />
                  Drukuj
                </button>
                <button
                  ...
                  className="px-4 py-2 bg-slate-200 dark:bg-black/70 text-black dark:text-white rounded-lg hover:bg-slate-300 dark:hover:bg-slate-600 transition-all"
                >
                  Zamknij
                </button>
              </div>
