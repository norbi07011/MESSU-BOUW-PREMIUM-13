  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 p-6">
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          ...
          <div className="flex flex-col justify-center px-4 md:px-6 lg:px-8">
            ...
            <div className="flex flex-wrap gap-4">
              {entries.length > 0 && (
                <button onClick={generateKilometersPDF} className="px-8 py-4 bg-gradient-to-r from-sky-500 to-blue-600 hover:from-sky-600 hover:to-blue-700 dark:from-blue-500 dark:to-blue-600 dark:hover:from-blue-400 dark:hover:to-blue-500 text-white rounded-xl font-bold text-lg shadow-lg dark:shadow-[0_0_20px_rgba(59,130,246,0.5)] hover:shadow-xl hover:scale-105 transition-all duration-300 flex items-center gap-3">
                  <Download size={20} />
                  Pobierz PDF
                </button>
              )}
              <button onClick={() => setShowForm(true)} className="px-10 py-5 bg-gradient-to-r from-sky-500 to-blue-600 hover:from-sky-600 hover:to-blue-700 dark:from-blue-500 dark:to-blue-600 dark:hover:from-blue-400 dark:hover:to-blue-500 text-white rounded-2xl font-black text-lg shadow-2xl dark:shadow-[0_0_25px_rgba(59,130,246,0.6)] transition-all duration-500 hover:scale-105 flex items-center gap-3">
        ...
        <div className="relative rounded-2xl bg-white/95 dark:bg-white/5 backdrop-blur-md border border-blue-200 dark:border-blue-500/30 shadow-xl p-6">
          ...
          <div className="mt-6 p-4 bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-500/30 rounded-xl">
            <div className="flex items-center gap-2 text-blue-800 dark:text-blue-300">
              <div className="p-1 bg-blue-200 dark:bg-blue-900/50 rounded-full">
            ...
            <p className="text-blue-700 dark:text-blue-400 text-sm mt-1 ml-7">
        ...
        <div className="relative rounded-2xl bg-white/95 dark:bg-white/5 backdrop-blur-md border border-blue-200 dark:border-blue-500/30 shadow-xl p-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-6">
            <div className="text-center p-6 bg-gradient-to-br from-blue-100 to-blue-200 rounded-xl border border-blue-300 hover:shadow-lg transition-all duration-300">
              ...
              <div className="text-blue-600 dark:text-blue-400 font-medium">Łączne kilometry</div>
              <div className="w-8 h-1 bg-blue-500 mx-auto mt-2 rounded-full"></div>
            </div>
            
            <div className="text-center p-6 bg-blue-100 dark:bg-blue-950/30 rounded-xl border border-blue-200 dark:border-blue-500/30 hover:shadow-lg transition-all duration-300">
              <div className="text-3xl font-bold text-blue-700 dark:text-blue-400 mb-2">
                €{yearlyReport.totalAmount.toFixed(2)}
              </div>
              <div className="text-blue-600 dark:text-blue-400 font-medium">Łączna kwota</div>
              <div className="w-8 h-1 bg-blue-500 mx-auto mt-2 rounded-full"></div>
            </div>
            ...
            <div className="text-center p-6 bg-blue-100 dark:bg-blue-950/30 rounded-xl border border-blue-200 dark:border-blue-500/30 hover:shadow-lg transition-all duration-300">
              ...
              <div className="text-blue-600 dark:text-blue-400 font-medium">Belastingvrij</div>
              <div className="w-8 h-1 bg-blue-500 mx-auto mt-2 rounded-full"></div>
            </div>
            ...
            <div className="text-center p-6 bg-blue-100 dark:bg-blue-950/30 rounded-xl border border-blue-200 dark:border-blue-500/30 hover:shadow-lg transition-all duration-300">
              ...
              <div className="text-blue-600 dark:text-blue-400 font-medium">Do opodatkowania</div>
              <div className="w-8 h-1 bg-blue-500 mx-auto mt-2 rounded-full"></div>
            </div>
          </div>
